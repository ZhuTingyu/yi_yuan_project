...
public class RotateLoading extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        int color = Color.parseColor("#ff9b19");
        ...
        if (null != attrs) {
            ...
            color = typedArray.getColor(R.styleable.RotateLoading_loading_color, Color.parseColor("#ff9b19"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#ff9b19"));
